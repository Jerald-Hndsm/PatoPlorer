    ...
    <header className="bg-sky-800 p-4 text-white fixed w-full h-20 shadow-md top-0 left-0 z-10">
      <div className="flex justify-between items-center">
        <h1 className="className=text-white font-extrabold text-3xl flex">
          Admin Dashboard<GrUserManager className="ml-2 pt-0.5" /> {/* Icon next to the header */}
        </h1>
        <div className="relative">
          <button 
            onClick={toggleDropdown} 
            className="px-4 py-2 rounded focus:outline-none hover:bg-gray-800 font-semibold"
          >
            Admin Settings
          </button>
          {isDropdownOpen && (
            <div className="absolute right-0 mt-2 w-48 bg-gray-700     rounded shadow-lg z-10">
              <ul className="py-2">
                <li>
                  ...
                  >
                    <GrUserManager className="mr-3 " /> Admin Profile
                  </button>
                </li>
                <li>
                  <button 
