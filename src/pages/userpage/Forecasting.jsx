...
const Forecasting = () => {
    ...
    return (
        <div className="p-8 mt-8 bg-blue-50">
            ...
            {/* Data Table and Info Tiles */}
            {data.length > 0 && (
                <div className="flex">
                    {/* Data Table */}
                    <div className="w-3/4 mb-4">
                        <h3 className="text-xl mb-1 font-sans font-semibold">Historical Data:</h3>
                        <div className="max-h-96 overflow-y-auto border relative overflow-x-auto shadow-md sm:rounded-lg max-w-4xl">
                    ...
                    {/* Info Tiles */}
                    <div className="w-1/4 flex flex-col space-y-4 pt-20">
                        ...
                        <div className="p-4 bg-blue-100 rounded-lg shadow-lg">
                            <h4 className="text-lg font-semibold">Orders Duration</h4>
                            <p className="text-gray-700">3 days</p>
                        </div>
                        <div className="p-4 bg-yellow-100 rounded-lg shadow-lg">
                            <h4 className="text-lg font-semibold">Forecasted Eggs</h4>
                            <p className="text-gray-700">150 eggs</p>
                        </div>
                    </div>
                </div>
            )}
